...
*/
class mod_typinggame_mod_form extends moodleform_mod {
...
*/
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('newmodulename', 'typinggame'), array('size'=>'64'));
        ...
        $mform->addHelpButton('name', 'newmodulename', 'typinggame');
